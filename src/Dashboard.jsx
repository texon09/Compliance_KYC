...
const Dashboard = ({ role, onLogout, logs = [], addLog = () => {} }) => {
  ...
  const renderContent = () => {
      ...
      return (
        <div className="tab-pane animated-fade">
          <div className="restricted-notice">
            ...
            <p>
              The Dashboard and Analytics are reserved for Managerial roles.
            </p>
            <button className="login-btn" onClick={handleCaseTabClick}>
              Go to Case Review
            </button>
          </div>
        </div>
    ...
    switch (activeTab) {
      case "dashboard":
        return (
          <div className="tab-pane animated-fade card">
            ...
            <div className="kpi-grid">
              ...
              <div className="kpi-card-vibrant box-green">
                ...
                <div className="mini-progress">
                  <div className="fill-green" style={{ width: "98%" }}></div>
                </div>
              </div>
              ...
              <div className="dashboard-block-solid">
                ...
                <div className="stat-circle-group">
                  <div className="stat-circle-box">
                    <div className="ring blue-text">85%</div>
                    <span>CPU Load</span>
                  </div>
                  <div className="stat-circle-box">
                    <div className="ring green-text">42%</div>
                    <span>Memory</span>
                  </div>
                </div>
              </div>
      ...
      case "settings":
        return (
          <div className="tab-pane animated-fade card">
            <h2 className="header">⚙️ System Settings</h2>
            <div className="settings-card">
              ...
              {employeeName && (
                <p>
                  Verified User: <strong>{employeeName}</strong>
                </p>
              )}
    ...
    <div className="dashboard-layout">
      <aside className="sidebar">
        ...
        <nav className="nav-menu">
          ...
          <button
            className={
              activeTab === "caseReview" ? "nav-btn active" : "nav-btn"
            }
        ...
        <div className="sidebar-footer">
          ...
          <div className="user-tag">
            {employeeName ? `👤 ${employeeName}` : role?.toUpperCase()}
          </div>
          <button className="logout-mini" onClick={onLogout}>
            Logout
          </button>
        </div>
      </aside>

      <main className="main-viewport container">{renderContent()}</main>
    </div>
  );
};
